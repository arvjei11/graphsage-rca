# This is a simulated microservice for handling authentication.
...
# This sets up the connection to Kafka. It retries if Kafka isn't ready yet.
...
# --- Logging Helper ---
# A standardized way to create and send logs
def log_message(level, message, trace_id, duration_ms, status_code):
    ...
    producer.flush()
    print(f"Logged: {log_entry}") # Also print to container logs for debugging
